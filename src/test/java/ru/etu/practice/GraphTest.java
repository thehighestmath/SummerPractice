...
class GraphTest {
    ...
    void firstNextStep(){
        ...
        // act
        List<Object> tuple = graph.nextStep();
    ...
    void newComponentNextStep(){
        ...
        // act
        tuple = graph.nextStep();
        expectedTuple.clear();
        expectedTuple.add(State.NEW_COMPONENT);
        expectedTuple.add(graph.getInputEdges().get(0));
    ...
    void appendNextStep(){
        ...
        expectedTuple.add(graph.getInputEdges().get(1));
    ...
    void loopNextStep(){
        ...
        List<Character> inputVertices = Arrays.asList('a', 'b', 'c', 'd');
        graph.initGraph(inputEdges, inputVertices);
        ...
        expectedTuple.add(graph.getInputEdges().get(2));
        ...
        expectedTuple.clear();
        expectedTuple.add(State.APPEND);
        expectedTuple.add(graph.getInputEdges().get(3));
